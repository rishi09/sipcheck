...
| `7595` | Replaying onboarding should reset follow-up reminders so the trigger can be observed again. | Replay now disables the app reminder setting, clears pending/delivered follow-ups and pending actions, and preserves the user's system notification authorization. |
...
- Unit/integration suite: 112 tests passed with zero failures.
