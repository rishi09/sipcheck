...
| Tavily + Gemini long-tail upgrade (active) | `codex/tavily-gemini-search` | Reserved: `SipCheck/Config.swift`, `SipCheck/Services/BeerDiscoveryService.swift`, `SipCheck/Views/Tabs/CheckTabView.swift`, `SipCheckTests/BeerDiscoveryServiceTests.swift`, `.github/workflows/testflight.yml`, `.github/workflows/tavily-usage.yml`, `backend/`, and search/privacy documentation. |
