...
| Tavily + Gemini long-tail upgrade (completed 2026-07-30) | `codex/tavily-gemini-search` | Released after exact-SHA Vercel verification, a 10/10 identity + 9/9 supported-category live eval, signed branch build 135, 187 unit/integration tests, and 11 UI flows in E2E run `30585095366`. No files remain reserved. |
