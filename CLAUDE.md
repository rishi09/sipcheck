...
| Founder feedback fixes (active 2026-07-17) | `claude/codex-feedback-fixes` | `CLAUDE.md`, `Gemfile`, `plans/reports/FOUNDER_FEEDBACK_2026-07-17.md`, `SipCheck/SipCheckApp.swift`, `SipCheck/Services/NotificationService.swift`, `SipCheck/Services/TastePreferences.swift`, `SipCheck/Views/OnboardingView.swift`, `SipCheck/Views/Tabs/ProfileTabView.swift`, `SipCheck/Views/Tabs/SettingsTabView.swift`, `SipCheckTests/TasteScorerSeedTests.swift`, `SipCheckUITests/SipCheckUITests.swift`, `fastlane/Fastfile`, and `scripts/product_judge.sh`. |
